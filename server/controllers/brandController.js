...
//         fileId: response.data.id, // ✅ now this will be defined
//            requestBody: {
//            role: 'reader',
//            type: 'anyone',
//    },
...
//         resource: fileMetadata,
//         media: media,
//         fields: 'id, webViewLink', // ✅ fileId include here
//     });

//     if (!response?.data?.id) {
//         throw new Error('❌ Google Drive upload failed: No fileId returned.');
//     }

//     // ✅ Set public permissions only if fileId exists
//     await drive.permissions.create({
