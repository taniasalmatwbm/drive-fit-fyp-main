...
//     try {
//       // const data = await fetch(`${process.env.REACT_APP_API}/api/car/getAll-car`, {
//       //   method: "GET",
//       //   headers: { "Content-type": "application/json" }
//       // })
//       const data = await fetch("/api/car/getAll-car", {
//         method: "GET",
//         headers: { "Content-type": "application/json" }
//       })
//       const data_ = await data.json()
//       console.log('data testing', data_)
...
//               <div className="col-md-12 col-lg-3 mb-3 mb-lg-0 my-3" key={p.slug}>
//                 <div className="card">
//                   <div className="d-flex justify-content-between p-3">
//                     <p className="lead mb-0 respBrand">{p.brand?.name || "Unknown Brand"}</p>
...
//                        <img 
//                        src={p.brand?.brandPictures || "/default-car.jpg"}
//                        alt={p.brand?.name || "No Brand"} 
...
//                     <img src={p.productPictures[0]} alt={p.name} style={{ maxWidth: '100%', maxHeight: '130px', objectFit: 'contain' }} className='border rounded' />
//                   </Link>
...
//                       <Link className='btn my-2' style={{ backgroundColor: 'blueviolet', color: 'white' }} to={`/car/${p.slug}`}>
...
const CarsHome = () => {
  ...
  const getAllcars = async () => {
    try {
      const res = await fetch("/api/car/getAll-car", {
        method: "GET",
        headers: { "Content-type": "application/json" }
      });
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between">
                      <h6 className="respBrand">
                        <PiCurrencyInrFill /> : {p.price} Lakhs
                      </h6>
                      <h6 className="respBrand">
                        <BsFuelPumpFill /> : {p.fuelType}
                      </h6>
                    </div>
                    <div className="d-flex justify-content-between my-2">
                      <h6 className="respBrand">
                        <TbStars /> : {p.safetyrating}
                      </h6>
                      <h6 className="respBrand">
                        <MdAirlineSeatReclineExtra /> : {p.seater} Seater
                      </h6>
                    </div>
                    <div className="text-center">
                      <Link
