                ...
                <div className='container'>
                    <div className='row align-items-center'>
                        <div className='col-md-6 header-img-section'>
                            <img src={hero} alt='Hello DriveFit' className='img-fluid' />
                        </div>
                        <div className="col-md-6 my-5 my-md-0 text-center text-md-start">
                            ...
                            <p className="banner-title-text " style={{ textAlign: 'justify' }}>Experience car buying like never before. DriveFit offers an extensive range of options, unbeatable deals, expert guidance, and a hassle-free journey to your dream car. Discover, compare, and drive with confidence.</p>
