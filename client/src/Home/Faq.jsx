                                ...
                                <div className="accordion-item">
                                    ...
                                    <div id="collapseOne" className="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div className="accordion-body">
                                            Yes, you can DriveFit, we make payment easy. Just navigate to our Cart  page and submit your information. Once our team receives it they will look it over and get back to you promptly.                                        </div>
                                    </div>
                                </div>
                                <div className="accordion-item">
                                ...
                                <div className="accordion-item">
                                    <h2 className="accordion-header" id="headingFive">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                            5. How many brands are available at DriveFit?
                                        </button>
                                    </h2>
