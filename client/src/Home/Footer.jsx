                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-5 footer_logo mb-4 mb-lg-0">
                            ...
                            <h3 style={{ color: 'blueviolet' }}>DriveFit</h3>
                            <p className="footer_text" style={{ textAlign: 'justify' }}>At DriveFit, we're dedicated to making your car buying experience as smooth as the road ahead. With a wide range of brands, expert guidance, secure transactions, and innovative features, we're your trusted partner on your journey to finding the perfect ride. Drive your dreams with DriveFit, where your satisfaction is our ultimate destination.</p>
                        </div>
                        ...
                        <div className="col-12 footer_credits text-center">
                            <span>© 2023 <a>DriveFit</a>™. All Rights Reserved.</span>
                        </div>
                    </div>
                </div>
            </section >
