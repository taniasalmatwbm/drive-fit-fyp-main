...
//             //  console.log("cars.productPictures",cars.productPictures)
//             //  console.log("cars.brand.brandPictures",cars.brand.brandPictures);
//                   setcars([...data_.cars].reverse());
...
//         try {
//             // const { data } = await axios.delete(`${process.env.REACT_APP_API}/api/car/delete-car/${id}`)
...
//                                                        <img
//                                                        src={p.brand.brandPictures[0] || '/default-brand.png'}
//                                                         alt={p.brand.name}
...
//                       <div className="d-flex justify-content-between p-3">
//                         <p className="lead mb-0">{p.brand.name}</p>
//                         {/* <p>{p.brand?.name || "Unknown Brand"}</p> */}
//                         <div
//                           className="rounded-circle d-flex align-items-center justify-content-center shadow-1-strong"
//                           style={{ width: '40px', height: '40px' }}>
//                           <Link to={`/brand/${p.brand.name}`} className="text-white mb-0 small">
